...
public partial class PlantApply : BasePage
{
    public string _View_sdate
    {
        get { return ViewState["PlantApply_sdate"] as string; }
        set { ViewState["PlantApply_sdate"] = value; }
    }

    public string _View_edate
    {
        get { return ViewState["PlantApply_edate"] as string; }
        set { ViewState["PlantApply_edate"] = value; }
    }

    public DataTable _View_查詢結果
    {
        get { return ViewState["PlantApply_查詢結果DT"] as DataTable; }
        set { ViewState["PlantApply_查詢結果DT"] = value; }
    }

    public DataTable _View_隔離廠區項目
    {
        get { return ViewState["PlantApply_隔離廠區項目DT"] as DataTable; }
        set { ViewState["PlantApply_隔離廠區項目DT"] = value; }
    }

    public int _View_ccid
    {
        get { return MTDBbase.ToInt32(ViewState["PlantApply_View_ccid"], -1); }
        set { ViewState["PlantApply_View_ccid"] = value; }
    }

    public int _View_flowid
    {
        get { return MTDBbase.ToInt32(ViewState["PlantApply_View_flowid"], -1); }
        set { ViewState["PlantApply_View_flowid"] = value; }
    }
